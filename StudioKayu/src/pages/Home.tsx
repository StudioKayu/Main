  ...
  return (
    <>
      ...
      <style>{`
                ...
                .sidebar-content-home h3 {
                    font-size: 18px;
                    margin-bottom: 12px;
                    letter-spacing: 2px;
                }
                .sidebar-content-home a {
                    color: #000;
                    text-decoration: none;
                    font-size: 14px;
                }
                .sidebar-content-home a:hover {
                    color: #f59e0b;
                }
                .sidebar-bottom-home {
                    margin-top: auto;
                ...
                .sidebar-register-home {
                    border: 1px solid #020617;
                    color: #020617;
                }
            `}</style>
      {/* SIDEBAR TOGGLE BUTTON */}
      <div className="sidebar-wrapper-home">
        <button
      ...
      {openMenu && (
        <>
          <div
            className="sidebar-overlay-home"
            onClick={() => setOpenMenu(false)}
          />
          <aside className="sidebar-menu-home">
            <div className="sidebar-top-home">
              <button
                className="sidebar-button-home"
                onClick={() => setOpenMenu(false)}
              >
            ...
            <div className="sidebar-bottom-home">
              <Link
                to="/login"
                className="sidebar-login-home"
                onClick={() => setOpenMenu(false)}
              >
                Masuk
              </Link>
              <Link
                to="/register"
                className="sidebar-register-home"
                onClick={() => setOpenMenu(false)}
              >
                Daftar
              </Link>
        ...
        <div className="mt-5 w-full max-w-[1200px] px-4 flex ml-20">
          <div className="grid grid-cols-3 gap-15 flex">
            <div className="w-full max-w-[590px]">
              ...
              <p className=" cursor-pointer hover:underline transition-all text-2xl mt-5">
                Urban Home
              </p>
