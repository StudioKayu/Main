  ...
  return (
    <>
      ...
      <style>{`
                ...
                .sidebar-button-promo:hover { background: #f1f5f9; }
                .sidebar-wrapper-promo {
                    position: absolute;
                    top: 88px;
                    left: 16px;
                    z-index: 40;
                ...
                .sidebar-top-promo img { width: 88px; height: auto; }
                ...
                .sidebar-content-promo h3 {
                    font-size: 18px;
                    margin-bottom: 12px;
                    letter-spacing: 2px;
                }
                .sidebar-content-promo a { color: #000; text-decoration: none; font-size: 14px; }
                .sidebar-content-promo a:hover { color: #f59e0b; }
                ...
                .sidebar-login-promo { background: #020617; color: #fff; }
                .sidebar-register-promo { border: 1px solid #020617; color: #020617; }
            `}</style>

      {/* SIDEBAR TOGGLE BUTTON */}
      <div className="sidebar-wrapper-promo">
        <button
          className="sidebar-button-promo"
      ...
      {openMenu && (
        <>
          <div
            className="sidebar-overlay-promo"
            onClick={() => setOpenMenu(false)}
          />
          <aside className="sidebar-menu-promo">
            <div className="sidebar-top-promo">
              <button
                className="sidebar-button-promo"
                onClick={() => setOpenMenu(false)}
              >
            ...
            <div className="sidebar-content-promo">
              <h3>MENU</h3>
            ...
            <div className="sidebar-bottom-promo">
              <Link
                to="/login"
                className="sidebar-login-promo"
                onClick={() => setOpenMenu(false)}
              >
                Masuk
              </Link>
              <Link
                to="/register"
                className="sidebar-register-promo"
                onClick={() => setOpenMenu(false)}
              >
                Daftar
              </Link>
      ...
      <section className="-ml-20 mt-10">
        <div className="max-w-[1200px] mx-auto px-4">
          <p className="text-5xl font-semibold">Penawaran Promo</p>
        </div>
        ...
        <div className="flex justify-start items-start flex-col gap-6 max-w-[1200px] mx-auto px-4">
          <p className="flex justify-start items-start font-bold  text-3xl">
            Tersedia di online dan toko
          </p>
          <p className="text-slate-600 text-xl">
            Jangan lewatkan kesempatan miliki perabot rumah baru dengan harga
            lebih terjangkau selama periode promo.
          </p>
        </div>
      ...
      <section className="-ml-20 mt-10">
        <div className="flex justify-start items-start flex-col gap-6 max-w-[1200px] mx-auto px-4">
          ...
          <p className="text-slate-600 text-xl">
            Nikmati potongan harga spesial yang hanya berlaku untuk waktu
            terbatas. Klik link di bio sekarang sebelum kehabisan!"
          </p>
        </div>
        <div className="max-w-[1200px] mx-auto px-6 mt-20 mb-20">
          <div className="flex flex-wrap md:flex-nowrap justify-center gap-12 w-[1000px]">
      ...
      <section className="-ml-20 mt-10">
        <div className="flex justify-start items-start flex-col gap-6 max-w-[1200px] mx-auto px-4">
          <p className="flex justify-start items-start font-bold  text-3xl">
            Promo bank dan finansial
          </p>
          <p className="text-slate-600 text-xl">
            Belanja lebih hemat, dapatkan cashback/e-voucher dengan metode
            pembayaran tertentu.
          </p>
        </div>
        <div className="max-w-[1200px] mx-auto px-6 mt-20 mb-20">
        ...
        <div className="flex justify-start items-start flex-col gap-6 max-w-[1200px] mx-auto px-4">
          <p className="text-slate-700">
            Sempurnakan momen akhir tahun dengan berbagai pilihan mebel dan
            aksesori berkualitas dari StudioMebel. Nikmati Year End Sale 2025
            dengan potongan harga hingga 70% untuk ratusan produk pilihan yang
            siap mempercantik rumah dan kantor Anda.
          </p>
        </div>
        <Footer />
      </section>
    ...
    <footer className="bg-gray-800 text-white py-6 mt-10 w-full">
      <div className="flex items-stretch ml-25">
        <img
          src="/photo/hp.png"
          alt=""
          className="w-[125px] ml-15 items-left justify-left flex"
        />
        <div className="flex flex-col  ml-20 mt-5 ">
          ...
          <div className="bg-white border-2 border-black rounded-xl w-[170px] h-[30px] mt-5 mb-5">
            <p className="text-black text-center  flex  justify-center items-center text-[12px] font-semibold mt-1">
              Download di Android{" "}
            </p>
          </div>
